...
export default function WorkflowEditor() {
    ...
    return (_jsxs(ReactFlow, { nodes: nodes, edges: edges, fitView: true, className: "bg-white", onNodesChange: useStore.getState().onNodesChange, onEdgesChange: useStore.getState().onEdgesChange, children: [_jsx(Background, {}), _jsx(Controls, {})] }));
}
